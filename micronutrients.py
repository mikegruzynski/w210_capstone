...
class MicroNutrients(object):
    def __init__(self, user_df):
        ...
        try:
            self.micro_df = pd.read_csv('C:/Users/mgruz/Desktop/w210/data/nutrient/recommended_micro_nutrients.csv',
                                        index_col='micro_nutrient')
        except:
            self.micro_df = pd.read_csv('C:/Users/pa351d/Desktop/w210/data/nutrient/recommended_micro_nutrients.csv',
                                        index_col='micro_nutrient')


    def micro_daily_macro_estimation(self):
        ...
        if self.user_df['gender'].get_values()[0] == 'male':
            ...
            if self.user_df['breastfeeding'].get_values()[0] == 'yes':
                column_list = female_breastfeeding_filter
            elif self.user_df['pregnant'].get_values()[0] == 'yes':
                column_list = female_pregnant_filter
            else:
                column_list = female_filter

        age = self.user_df['age'].get_values()[0]
