...
class Models(object):
    def __init__(self, recipe_init):
        ...
        with open('C:/Users/mgruz/Desktop/w210/data/models/NDB_tag_unique_unique_dict.json') as f:
            self.NDB_tag_unique_unique_dict = json.load(f)


        # load json and create model
        json_file = open('C:/Users/mgruz/Desktop/w210/data/models/model_simple_nn.json', 'r')
        loaded_model_json = json_file.read()
        json_file.close()
        self.loaded_model = model_from_json(loaded_model_json)
        # load weights into new model
        self.loaded_model.load_weights('C:/Users/mgruz/Desktop/w210/data/models/model_simple_nn_WEIGHTS.h5')
...
class GA(object):
    def __init__(self):
        self.recipe_df = pd.read_csv('C:/Users/mgruz/Desktop/w210/code/rootseller/GA_help/test_GA.csv', encoding="cp1252")
        self.recipe_df_normalized = pd.read_csv('C:/Users/mgruz/Desktop/w210/code/rootseller/GA_help/test_GA_normalized.csv', encoding="cp1252")
        self.user_df = pd.read_csv('C:/Users/mgruz/Desktop/w210/code/rootseller/GA_help/test_user_df.csv', encoding="cp1252")
    ...
    def AMGA(self, num_generations, meals_per_week, amount_per_population, amount_parents_mating, weekly_diet_amount):
