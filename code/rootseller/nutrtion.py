...
class Nutrition(object):
    def __init__(self):
        ...
        try:
            self.nutritional_normalized_database = pd.read_csv('C:/Users/mgruz/Desktop/w210/data/nutrient/compiled/nutrition_master_normalized_df.csv').fillna(0.0)
        except:
            self.nutritional_normalized_database = pd.read_csv('C:/Users/pa351d/Desktop/w210/data/nutrient/compiled/nutrition_master_normalized_df.csv').fillna(0.0)
